...
> 本仓库从头编写了 `hclust_manual` 函数，严格遵循 Lance–Williams 递推公式，确保所有方法的输出完全符合理论预期。
...
| 方法        | α_A                         | α_B                         | β                             | 备注                                   |
|-------------|-----------------------------|-----------------------------|-------------------------------|----------------------------------------|
| single      | 1/2                         | 1/2                         | 0                             | 同时取 γ = -1/2 可写为 d(C,X)=min(d(A,X),d(B,X)) |
| complete    | 1/2                         | 1/2                         | 0                             | 同时取 γ = +1/2 可得最大值               |
| average     | |A|/(|A|+|B|)               | |B|/(|A|+|B|)               | 0                             |                                        |
| centroid    | |A|/(|A|+|B|)               | |B|/(|A|+|B|)               | - (|A|*|B|)/(|A|+|B|)^2        | **必须使用平方距离**                   |
| median      | 1/2                         | 1/2                         | -1/4                          | **必须使用平方距离**                   |
| ward        | (|A|+|X|)/(|A|+|B|+|X|)     | (|B|+|X|)/(|A|+|B|+|X|)     | - |X|/(|A|+|B|+|X|)            | **必须使用平方距离**                   |
